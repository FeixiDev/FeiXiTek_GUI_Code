...
#
    def __decodeABTS(self, eng_number):
        ...
        if start_idx_a1 == self.f_length:
            ...
            if self.lines[start_idx_a1].find('ABTS') != -1:
        ...
        if start_idx_a2 == self.f_length:
            ...
            if self.lines[start_idx_a2].find('ABTS') != -1:
        ...
        if start_idx_b1 == self.f_length:
            ...
            if self.lines[start_idx_b1].find('ABTS') != -1:
        ...
        if start_idx_b2 == self.f_length:
            ...
            if self.lines[start_idx_b2].find('ABTS') != -1:
